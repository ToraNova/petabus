...
public class push extends AppCompatActivity implements View.OnClickListener {
    ...
    public void LogOut() {
        ...
        netmanExecution("GET", testURL);

        status.setText(getResources().getIdentifier("@string/logoutStatus", "string", this.getPackageName()));
    ...
    public void outputRating(String fb){
        //display the customer rating
        //rating.setText(fb + getResources().getIdentifier("@string/output_feedback", "string", this.getPackageName()));
        rating.setText(fb + "/ 5.0");
        Log.d(DebugTag, "display rating: " + fb);
    }
    ...
    private void netmanExecution(String t, String u){
        netman.setType(t);
        netman.setUrl(u);
        netman.execute();
    }
